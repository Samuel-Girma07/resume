...
class ProfileOrb {
    constructor(containerId, options = {}) {
        ...
        this.hoverIntensity = options.hoverIntensity || 0.2;
    ...
    init() {
        ...
        const frag = /* glsl */ `
            ...
            // Theme Colors: Yellowish / Gold
            const vec3 baseColor1 = vec3(1.0, 0.9, 0.1); // Bright Gold/Yellow
            const vec3 baseColor2 = vec3(1.0, 0.8, 0.0); // Rich Yellow
            const vec3 baseColor3 = vec3(0.6, 0.5, 0.0); // Deep Yellow-Gold
        ...
        this.program = new Program(this.gl, {
            ...
            uniforms: {
                ...
                backgroundColor: { value: this.hexToVec3(this.backgroundColor) }
            }
        });
        ...
        parent.addEventListener('mousemove', (e) => this.handleMouseMove(e));
    ...
    update(t) {
        ...
        this.program.uniforms.hover.value += (this.targetHover - this.program.uniforms.hover.value) * 0.1;

        if (this.rotateOnHover && this.program.uniforms.hover.value > 0.5) {
